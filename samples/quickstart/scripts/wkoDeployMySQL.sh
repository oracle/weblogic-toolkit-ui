    ...
    template:
        ...
        spec:
            ...
            imagePullSecrets:
                - name: ${SECRET_NAME}
EOF
  echo "Failed to create deployment todolist-mysql-deployment in namespace ${MYSQL_NAMESPACE}...exiting" >&2
  exit 1
fi
...
spec:
    ...
    ports:
        - port: 3306
EOF
  echo "Failed to create service mysql in namespace ${MYSQL_NAMESPACE}...exiting" >&2
  exit 1
fi

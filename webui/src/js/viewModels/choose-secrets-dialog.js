...
function(accUtils, ko, i18n, props, validationHelper, ArrayDataProvider) {
  function ChooseSecretsDialogModel(args) {
    ...
    this.labelMapper = (labelId) => {
      return i18n.t(`vz-application-design-choose-secrets-${labelId}`);
    };
    ...
    this.okInput = () => {
      ...
      const result = {
        secretNames: this.selectedSecretNames(),
      };
   ...
   */
  return ChooseSecretsDialogModel;
});

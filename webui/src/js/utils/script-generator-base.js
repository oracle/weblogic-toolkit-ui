...
define(['models/wkt-project', 'utils/aux-image-helper', 'utils/sh-script-adapter', 'utils/powershell-script-adapter',
  'utils/cmd-script-adapter'],
function(project, auxImageHelper, ShAdapter, PsAdapter, CmdAdapter) {
  ...
  class ScriptGeneratorBase {
    ...
    getSecretVariableName(secretName, suffix) {

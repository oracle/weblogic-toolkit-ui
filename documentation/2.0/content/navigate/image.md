...
3. Adds the installers to the WebLogic Image Tool (WIT) cache on the local machine using the WIT [Cache](https://oracle.github.io/weblogic-image-tool/userguide/tools/cache/)
   command.

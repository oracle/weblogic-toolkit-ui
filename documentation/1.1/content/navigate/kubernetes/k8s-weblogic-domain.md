...
This pane focuses on the container primary image to use to run the WebLogic Server domain in a container. If you select `Create a New Primary Image`, then click `Go To Create Primary Image Page` to configure the image.  
...
If you select `Create a New Auxiliary Image`, then click `Go To Create Auxiliary Image Page` to configure the image.

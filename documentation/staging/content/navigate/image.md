...
when building your primary or auxiliary image, we highly recommend using [WDT 2.0](https://github.com/oracle/weblogic-deploy-tooling/releases) to
take advantage of enhanced capabilities that reduce the chance of deploy-time errors created due to a bad model.    
{{% /notice %}}
